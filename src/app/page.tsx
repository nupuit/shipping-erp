    ...
    const { error } = await supabase.from("bookings").insert([
      {
        ...
        freight_type: booking.freight_type_id,
        container_owner: booking.container_owner_id,
        ...
        srr: booking.srr,
        service1: booking.service1_id,
        service2: booking.service2_id,
        cargo_details: items,
